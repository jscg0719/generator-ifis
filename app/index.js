...
var IfisGenerator = module.exports = function IfisGenerator(args, options, config) {
...
util.inherits(IfisGenerator, yeoman.generators.Base);

IfisGenerator.prototype.askFor = function askFor() {
    var cb = this.async();
...
IfisGenerator.prototype.app = function app() {
...
IfisGenerator.prototype.projectfiles = function projectfiles() {
